...
public interface IAssetHelper
{
    ...
    /// </summary>
    /// <remarks>
    /// In development, this method simply prepends `assets/` to <paramref name="path" />. In all
    /// other environments, it prepends `prod-assets/` to the corresponding path in the production
    /// asset manifest.
    /// </remarks>
    /// <param name="context">
    /// The action context.
