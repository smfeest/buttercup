...
public class UseSortByIdAttribute<T> : ObjectFieldDescriptorAttribute where T : IEntityId
{
    public UseSortByIdAttribute([CallerLineNumber] int order = 0) => this.Order = order;
