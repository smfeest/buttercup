...
public class RequiredLabelTagHelper : TagHelper
{
    ...
    /// </summary>
    /// <value>
    /// <b>true</b> if the required suffix should be added to the field label; <b>false</b> if it
    /// shouldn't; <b>null</b> if the suffix should be added if and only if the model value
