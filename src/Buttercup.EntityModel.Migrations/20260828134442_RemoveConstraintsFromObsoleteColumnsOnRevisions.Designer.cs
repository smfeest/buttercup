...
namespace Buttercup.EntityModel.Migrations
{
    ...
    [Migration("20260828134442_RemoveConstraintsFromObsoleteColumnsOnRevisions")]
    partial class RemoveConstraintsFromObsoleteColumnsOnRevisions
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Buttercup.EntityModel.CommentRevision", b =>
                {
                    ...
                    b.HasIndex("CommentId")
                        .HasDatabaseName("ix_comment_revisions_comment_id");
            ...
            modelBuilder.Entity("Buttercup.EntityModel.RecipeRevision", b =>
                {
                    ...
                    b.HasIndex("RecipeId")
                        .HasDatabaseName("ix_recipe_revisions_recipe_id");
