...
namespace Buttercup.EntityModel.Migrations
{
    ...
    [Migration("20260726145827_AddRecipeAudits")]
            ...
            modelBuilder.Entity("Buttercup.EntityModel.RecipeAudit", b =>
                {
                    ...
                    b.HasIndex("RecipeId", "RevisionNumber")
                        .HasDatabaseName("ix_recipe_audits_recipe_id_revision");
            ...
            modelBuilder.Entity("Buttercup.EntityModel.RecipeAudit", b =>
                {
                    ...
                    b.HasOne("Buttercup.EntityModel.RecipeRevision", "Revision")
                        .WithMany()
                        .HasForeignKey("RecipeId", "RevisionNumber")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_recipe_audits_recipe_revisions_recipe_id_revision");
