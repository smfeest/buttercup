...
namespace Buttercup.EntityModel.Migrations
{
    ...
    [Migration("20260826205739_BackfillRecipeAndCommentAudits")]
    partial class BackfillRecipeAndCommentAudits
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Buttercup.EntityModel.CommentRevision", b =>
                {
                    ...
                    b.HasIndex("CommentId", "Revision")
                        .IsUnique()
                        .HasDatabaseName("ix_comment_revisions_comment_id_revision");
            ...
            modelBuilder.Entity("Buttercup.EntityModel.RecipeRevision", b =>
                {
                    ...
                    b.HasIndex("RecipeId", "Revision")
                        .IsUnique()
                        .HasDatabaseName("ix_recipe_revisions_recipe_id_revision");
