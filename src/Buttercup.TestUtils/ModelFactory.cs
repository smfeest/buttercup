...
public sealed class ModelFactory
{
    ...
    public CommentRevision BuildCommentRevision(Comment comment) =>
        new()
        {
            Id = this.NextInt(),
            Comment = comment,
        ...
        Recipe recipe, RecipeAction action, bool setOptionalAttributes = false)
    {
        var revision = action == RecipeAction.Delete
            ? null :
            this.BuildRecipeRevision(recipe, setOptionalAttributes);
        var actor = setOptionalAttributes ? this.BuildUser() : null;
    ...
    public RecipeRevision BuildRecipeRevision(Recipe recipe, bool setOptionalAttributes = false) =>
        new()
        {
            Id = this.NextInt(),
            Recipe = recipe,
